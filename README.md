...
We suggest recursively cloning the commit for OpenPCDet provided in this repository and building the library from scratch with `python setup.py develop` in case a version for OpenPCDet is already installed and incompatible with this configuration.
